...
const VideoScreen: React.FC = () => {
    ...
    const handleSetAnswers = async () => {
        if (recordedChunks.length) {
            ...
            try {
                ...
                console.log(error);
                showAlert('Uh-oh! 😬 Some error has occurred. Please try again. 🔄');
                goToIdleState();
            }
        }
    };
    ...
    const handleSubmitTest = async () => {
        ...
        try {
            ...
            const res = await axios.post(`/hr-interview/assessment/${testId}/submit`, {
                questions: solutions,
            });
            if (res.status === 201) {
                showAlert(
    ...
    return (
        <>
            ...
            <div className="flex-1 md:border-[1.5px] border-gray-300 h-2/3 rounded-md md:overflow-hidden flex flex-col md:flex-row bg-gray-50 relative">
                ...
                <div className="md:border-r-[0.75px] hidden md:block border-gray-400 flex-1">
                    <Webcam
                        ref={WebCamRef}
