...
const Navbar = () => {
    ...
    return (
        <div className="border-[1.5px] border-gray-300 p-2 flex-col sm:flex-row flex justify-between items-center rounded-md">
            ...
            <div className="flex items-center gap-4">
                <p className="text-sm mt-2 sm:mt-0 text-gray-700  sm:w-[300px] sm:text-end">
