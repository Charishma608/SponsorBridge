...
const Navbar = () => {
    const { data, timer, setExitButtonPressed, exitButtonPressed } = useTestContext();
    ...
    return (
        <div className="border-[1.5px] flex-col sm:flex-row border-gray-300  p-2 flex sm:justify-between sm:items-center rounded-md">
            <div className="flex items-center gap-3 ">
                ...
                <span className="text-sm">Test Duration ( {data?.duration_in_minutes} Mins )</span>
            </div>
            <div className="flex items-center mt-3 sm:mt-0 gap-4  ">
                <p className="text-sm ps-2 sm:ps-0 text-gray-700 w-[300px] sm:text-end">
