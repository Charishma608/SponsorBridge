...
const Sidebar = () => {
    ...
    return (
        <div className="h-full md:w-1/3 border-[1.5px] border-gray-300 rounded-md p-4 hidden md:flex flex-col justify-between">
            <div>
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="h-10 w-10 grid place-content-center border-2 border-primary rounded-full">
                            <FaRegClock />
                        </div>
                    </div>
            ...
            <p className="text-center font-semibold text-md">All the best for your test</p>
        </div>
    );
};
