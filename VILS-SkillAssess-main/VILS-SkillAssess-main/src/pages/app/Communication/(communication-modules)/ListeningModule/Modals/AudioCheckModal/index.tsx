...
const AudioCheckModal: React.FC<AudioCheckModalProps> = ({ onCancel, onSuccess }) => {
    return (
        <ModalWrapper>
            {/*  overflow-hidden overflow-y-scroll sm:p-4 sm:w-[500px] */}
            <div className="overflow-y-scroll overflow-hidden w-[400px] h-[550px] md:h-[628px]  md:w-[800px] px-6 py-4 pb-6 bg-white rounded-md">
                ...
                <div className="mt-6">
                    <div className="p-6 bg-gray-200 m-auto w-[300px] md:w-[400px] text-center">
                        <p className="text-sm">
                        ...
                        <div className="mt-4 m-auto  w-fit">
                            <audio src={TestAudio} controls className="w-[200px] md:w-[350px]" />
                        </div>
                    </div>
                </div>
