...
const AudioVideoCheckModal: React.FC<AudioVideoCheckModalProps> = ({ onSuccess, onCancel }) => {
    ...
    return (
        <ModalWrapper>
            <div className="bg-white mx-auto  rounded-md p-2 w-[95%] md:w-[80%] min-h-[628px] overflow-hidden overflow-y-scroll sm:p-4 sm:w-[500px]">
                <div className="flex items-center justify-end relative">
                    <p className="font-semibold absolute left-1/2 text-center w-full -translate-x-1/2 pt-4">
                ...
                <div className="mt-4">
                    ...
                    <p className="text-sm mt-2 text-justify">
                        ...
                        microphone of your system in a quiet enviroment with minimal background
                        noise.
                    </p>
                </div>
                <div className="mt-4">
