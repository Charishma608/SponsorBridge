    ...
    const loadAllReports = useCallback(async () => {
        const requestUrl =
            viewReportsButtonClicked && assessmentId !== ''
                ? `/technical-mcqr/assessment/${assessmentId}/report/all`
                : `/report/technical-mcq`;
            ...
            <div className="flex flex-col gap-4 my-4">
                ...
                <div className="flex flex-wrap gap-4">
                    {data?.map((dt: any, index: number) => (
                        <div className="flex flex-col p-4 rounded-lg shadow-md border-2 w-[300px]">
                            ...
                            <button
                                ...
                                onClick={() => {
                                    navigate({
                                        pathname: '/reports/tech-mcqs-report',
