...
const SupportingAndCooperatingTab = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-2 items-center">
                <div>
                    <p>{data?.['Supporting and Cooperating'].summary}</p>
                </div>
                <div>
                    <CircularProgressBarGraph
                        value={Math.round(data?.comptency_score?.['Supporting and Cooperating'])}
                        size={150}
                        radius={60}
                        label={
                            Math.round(data?.comptency_score?.['Supporting and Cooperating']) + '%'
                        }
            ...
            <div className="border-t-[1.5px] border-gray-300">
                ...
                <div className="flex flex-col gap-3">
                    {data?.['Supporting and Cooperating']?.development_area?.map(
...
export default SupportingAndCooperatingTab;
