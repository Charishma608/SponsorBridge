    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-2 items-center">
                <div>
                    <p>{data?.['Leading and Deciding'].summary}</p>
                </div>
                <div>
                    <CircularProgressBarGraph
                        value={Math.round(data?.comptency_score?.['Leading and Deciding'])}
                        size={150}
                        radius={60}
                        label={Math.round(data?.comptency_score?.['Leading and Deciding']) + '%'}
            ...
            <div className="border-t-[1.5px] border-gray-300">
                ...
                <div className="flex flex-col gap-3">
                    {data?.['Leading and Deciding']?.development_area?.map(
...
export default LeadingAndDecidingTab;
