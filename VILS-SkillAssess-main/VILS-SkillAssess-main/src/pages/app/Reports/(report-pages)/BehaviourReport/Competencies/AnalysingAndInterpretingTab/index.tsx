...
const AnalysingAndInterpretingTab = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-2 items-center">
                <div>
                    <p>{data?.['Analysing and Interpreting'].summary}</p>
                </div>
                <div>
                    <CircularProgressBarGraph
                        value={Math.round(data?.comptency_score?.['Analysing and Interpreting'])}
                        size={150}
                        radius={60}
                        label={
                            Math.round(data?.comptency_score?.['Analysing and Interpreting']) + '%'
                        }
            ...
            <div className="border-t-[1.5px] border-gray-300">
                ...
                <div className="flex flex-col gap-3">
                    {data?.['Analysing and Interpreting']?.development_area?.map(
...
export default AnalysingAndInterpretingTab;
