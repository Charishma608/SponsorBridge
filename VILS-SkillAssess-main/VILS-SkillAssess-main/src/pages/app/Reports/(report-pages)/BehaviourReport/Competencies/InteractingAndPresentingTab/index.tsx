...
const InteractingAndPresentingTab = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-2 items-center">
                <div>
                    <p>{data?.['Interacting and Presenting'].summary}</p>
                </div>
                <div>
                    <CircularProgressBarGraph
                        value={Math.round(data?.comptency_score?.['Interacting and Presenting'])}
                        size={150}
                        radius={60}
                        label={
                            Math.round(data?.comptency_score?.['Interacting and Presenting']) + '%'
                        }
            ...
            <div className="border-t-[1.5px] border-gray-300">
                ...
                <div className="flex flex-col gap-3">
                    {data?.['Interacting and Presenting']?.development_area?.map(
...
export default InteractingAndPresentingTab;
