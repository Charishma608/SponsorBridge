...
// Configs
import axios, { axiosV2 } from 'configs/axios.config';

// External Imports
import { IoArrowBackSharp } from 'react-icons/io5';

const InterviePrepHub = () => {
        ...
        try {
            ...
            const requestUrl =
                viewReportsButtonClicked && assessmentId !== ''
                    ? `/practice-test/assessment/${assessmentId}/report/all`
                    : `/report/practice-test`;

            const _axios = viewReportsButtonClicked && assessmentId !== '' ? axiosV2 : axios;
...
export default InterviePrepHub;
