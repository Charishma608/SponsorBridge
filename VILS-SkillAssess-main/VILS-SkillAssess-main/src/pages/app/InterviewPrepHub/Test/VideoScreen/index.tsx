...
import { URL } from 'configs/socket.config';
import { nanoid } from 'nanoid';
import { BUFFER_TIME } from 'configs/socket.config';
...
const VideoScreen: React.FC = () => {
    ...
    const handleSubmitTest = async () => {
        if (solutions.length === 0) {
            showAlert(
                ...
                () => {
                    ...
                    navigate('/dashboard?activeTab=overall&type=communication');
                },
            );
            return;
        }
        ...
        try {
            ...
            const res = await axiosV2.post(`/practice-test/assessment/${testId}/submit`, solutions);
