...
interface JoiningYearChangeModalProps {
    closeAction: () => void;
}

const JoiningYearChangeModal: React.FC<JoiningYearChangeModalProps> = ({
    closeAction = () => {},
}) => {
    ...
    for (let i = 1990; i <= currDate.getFullYear(); i++) {
        JoiningYearData.push(i.toString());
    }
            ...
            >
                <div className="flex items-start justify-between">
                    <div className="flex flex-col gap-1">
                        <TextSubHeading className="text-2xl">Joining Year</TextSubHeading>
                        <p className="text-sm">Enter Joining Year</p>
                    </div>
                ...
                <div className="my-6">
                    <DropDown
                        data={JoiningYearData}
                        heading="Select Your Joining Year"
...
export default JoiningYearChangeModal;
