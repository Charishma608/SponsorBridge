...
interface FirstNameChangeModalProps {
    closeAction: () => void;
}

const FirstNameChangeModal: React.FC<FirstNameChangeModalProps> = ({ closeAction = () => {} }) => {
            ...
            >
                <div className="flex items-start justify-between">
                    <div className="flex flex-col gap-1">
                        <TextSubHeading className="text-2xl">First Name</TextSubHeading>
                        <p className="text-sm">Enter First Name</p>
                    </div>
...
export default FirstNameChangeModal;
