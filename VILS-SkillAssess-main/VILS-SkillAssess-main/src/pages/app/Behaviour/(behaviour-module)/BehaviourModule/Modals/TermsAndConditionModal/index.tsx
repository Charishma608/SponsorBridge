        ...
        <ModalWrapper>
            <div className="w-[600px] px-6 py-4 pb-6 bg-white rounded-md flex flex-col items-center">
                ...
                <div className="mt-4 flex flex-col gap-4 text-sm">
                    <p>
                        By engaging in the Behaviour test, you are acknowledging and consenting to
                        the following terms and conditions. The primary objective of this assessment
                        is to gauge and assess your emotional well-being. We assure you that all
                    ...
                    <p>
                        Participation in the Behaviour test is entirely voluntary, and you retain
                        the right to withdraw from the assessment at any point without the need for
